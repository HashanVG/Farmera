...
const FertilizerSubsidy = () => {
  ...
  const validate = () => {
    ...
    if (!formData.document) newErrors.document = 'Please upload the certified deed or license';
    ...
    <main className="min-h-screen pt-32 pb-16 px-6 flex flex-col items-center relative bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1625246333195-78d9c38ad449?q=80&w=2070&auto=format&fit=crop')" }}>
      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        <div className="text-center mb-10 mt-8">
          <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500 mb-4 drop-shadow-sm">
            Fertilizer Subsidy Application
          </h1>
          <p className="text-white/90 text-lg font-medium max-w-xl mx-auto drop-shadow">
            Empowering farmers with high-quality fertilizers. Complete the form below to apply for your subsidy allocation.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-7 relative z-10">
            ...
            <div>
              <label className="block text-sm font-bold text-white mb-2 ml-1">
                Deed or License (Certified by Gramaniladari)
              </label>
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-yellow-400 hover:bg-yellow-300 text-yellow-900 font-bold text-xl py-4 px-8 rounded-xl shadow-[0_0_20px_rgba(250,204,21,0.3)] hover:shadow-[0_0_25px_rgba(250,204,21,0.5)] transform hover:-translate-y-1 transition-all duration-300"
              >
                Submit Application
              </button>
            </div>
...
export default FertilizerSubsidy;
